  ...
  <body>
    ...
    <header class="header">
      ...
      <nav class="navbar navbar-expand-lg navbar-default navbar-fixed-top">
        ...
        <div class="container">
          <!--begin logo -->
          <a class="navbar-brand" href="#">Control-20</a>
          <!--end logo -->
          ...
          <div class="navbar-collapse collapse" id="navbarCollapse">
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="discover-link">
                <a href="php/registration.php" class="discover-btn">Sign In/Up</a>
              </li>

              <li>
                <a href="#" style="padding-right: 0px !important; font-size: 14px !important;">Eng</a>
                <p style="color: #071e55; display: inline; font-size: 14px !important;">|</p>
                <a href="#" style="padding-left: 0px !important; font-size: 14px !important;">Ru</a>
              </li>
            </ul>
            <!--end navbar-nav -->
          </div>
    ...
    <section class="home-section" id="home">
      ...
      <div class="container">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-6">
            <h1>
              Discover The World's Most Advanced Online COVID-19 Monitoring
              System
            </h1>

            <p class="hero-text">
              Excepteur sint occaecat cupidatat nonet proident, vante nisle
              culpamitus qui officia deserunt etimus quis autem netsum loremisat
              entimus velis netsad.
            </p>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-10 mx-auto text-center partners">
            ...
            <img
              src="https://startup.kase.kz/images/00/531f79fbfa01bf774d23cdb03355c57a.jpg"
              class="partners"
              alt="image"
            />
            <img
              src="https://qazinn.kz/wp-content/uploads/2020/08/QazInnovations-%D0%BB%D0%BE%D0%B3%D0%BE%D1%82%D0%B8%D0%BF-ou74kdt2ybvwj66rqqo9ho4bj9ukol5d0vl9bkh3g0.png"
              class="partners"
              alt="image"
            />
            <img
              src="https://instagram.fala5-1.fna.fbcdn.net/v/t51.2885-19/s320x320/139490454_228247388915107_4153747045174462504_n.jpg?_nc_ht=instagram.fala5-1.fna.fbcdn.net&_nc_ohc=FcP9tNlIL-gAX8IW0bN&tp=1&oh=9844458d9c92178592ad99220ad674db&oe=605BB7CB"
              class="partners"
              alt="image"
            />
            <img
              src="https://instagram.fala5-1.fna.fbcdn.net/v/t51.2885-19/s320x320/140367978_101670105194256_4147469125264745849_n.jpg?_nc_ht=instagram.fala5-1.fna.fbcdn.net&_nc_ohc=bYxiiVW8hbIAX_av1Fl&tp=1&oh=fc90bd524f81729d9fd5ec3d19015be3&oe=605A6432"
              class="partners"
              alt="image"
            />
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-12 text-center margin-bottom-10">
            ...
            <p class="section-subtitle">
              Discover how our amazing team can help your health and work
            </p>
          </div>
          <!--end col-md-12 -->
        </div>
    ...
    <section class="section-grey" id="testimonials">
      ...
      <div class="container">
        ...
        <div class="row">
          <!--begin col md 12 -->
          <div class="col-md-12 mx-auto padding-bottom-40">
                  ...
                  <div class="row align-items-center testim-inner">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="video-popup-wrapper">
                        ...
                        <div class="popup-gallery">
                          <img
                            src="http://placehold.it/555x365"
                            alt="testimonials"
                            class="width-100 video-popup-image bottom-margins-images"
                          />

                          <a
                            class="popup4 video-play-icon"
                            href="https://www.youtube.com/watch?v=FPfQMVf4vwQ"
                          >
                            <i class="fas fa-play"></i>
                          </a>
                    ...
                    <div class="col-md-6 testim-info">
                      ...
                      <p>
                        ...
                        aspernatis netsum loris fugit, sed quia magnitus dolores
                        eos quis ratione sequi etum nets.
                      </p>

                      <h6>— Jennifer Smith<span> | Web Designer</span></h6>
                    </div>
                    <!--end col-md-5 -->
                  </div>
                  <!--end row -->
                ...
                <div class="carousel-item">
                  ...
                  <div class="row align-items-center testim-inner">
                    ...
                    <div class="col-md-6 testim-info">
                      ...
                      <h6>— John Doe<span> | General Manager</span></h6>
                    </div>
                    <!--end col-md-5 -->
                  </div>
                  <!--end row -->
                ...
                <div class="carousel-item">
                  ...
                  <div class="row align-items-center testim-inner">
                    ...
                    <div class="col-md-6 testim-info">
                      ...
                      <h6>— Emily Richards<span> | Copywriter</span></h6>
                    </div>
                    <!--end col-md-5 -->
                  </div>
                  <!--end row -->
        ...
        <div class="row">
          ...
          <div class="col-sm-12 col-md-4 text-center margin-top-30">
            <img
              ...
              class="team-img green width-100"
              alt="pic"
            />

            <div class="team-item">
              <h3>Mirlan Jussambayev</h3>

              <div class="team-info green"><p>CEO</p></div>
          ...
          <div class="col-sm-12 col-md-4 text-center margin-top-30">
            <img
              src="http://placehold.it/555x555"
              class="team-img red width-100"
              alt="pic"
            />

            <div class="team-item">
              <h3>Abylay Sydykov</h3>

              <div class="team-info red"><p>Lead Web-Developer</p></div>
          ...
          <div class="col-sm-12 col-md-4 text-center margin-top-30">
            <img
              src="http://placehold.it/555x555"
              class="team-img yellow width-100"
              alt="pic"
            />

            <div class="team-item">
              <h3>Maksim Rybalkin</h3>

              <div class="team-info yellow"><p>Lead Circuit Engineer</p></div>
    ...
    <section class="section-grey">
      ...
      <div class="container">
        ...
        <div class="row align-items-center">
          <!--begin col-md-6-->
          <div
            class="col-md-6 padding-bottom-30 wow slideInLeft"
          ...
          >
            <div class="right-dots-img margin-right-15">
              <img
                ...
                class="width-100 bottom-margins-images"
                alt="pic"
              />
            </div>
          </div>
          ...
          <div class="col-md-6">
            <h3>
              Discover how we can help you to monitor your health online and
              more secure.
            </h3>
            ...
            <ul class="benefits">
              <li>
                <i class="fas fa-check"></i> <b>Quias netus magni</b> netsum eos
                qui ratione sequi.
              </li>
              <li>
                <i class="fas fa-check"></i> Venis ratione sequi netus
                <b>enim quia tempor</b> magni.
              </li>
              <li>
                <i class="fas fa-check"></i> Enim <b>ipsam netus</b> voluptatem
                quia voluptas.
              </li>
            </ul>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-6">
            ...
            >
              ...
              >
                <!--begin features-second-->
                <div class="features-second">
                  <img src="images/services-icon2.png" alt="pic" />
              ...
              >
                <!--begin features-second-->
                <div class="features-second">
                  <img src="images/services-icon3.png" alt="pic" />
          ...
          <div class="col-md-6 padding-bottom-30">
            <div class="tab-content margin-left-20" id="v-pills-tabContent">
              <div
                class="tab-pane fade show active left-dots-img"
                id="v-pills-home"
                role="tabpanel"
              ...
              >
                <img
                  src="http://placehold.it/555x425"
                  class="width-100 top-margins-images"
                  alt="pic"
                />
              </div>

              <div
                class="tab-pane fade left-dots-img"
                id="v-pills-profile"
                role="tabpanel"
    ...
    <section class="section-grey" id="pricing">
      ...
      <div class="container">
        ...
        <div class="row align-items-center">
          ...
          <!--begin col-md-4-->
          <div
            class="col-md-4 col-sm-6 wow bounceIn"
            data-wow-delay="0.25s"
            style="
              visibility: visible;
              animation-delay: 0.25s;
        ...
        <div class="row no-gutters">
          ...
          <div class="col-md-6">
            ...
            <div class="small-col-inside">
              <h4>
                Discover four ways to lead a performing, extremly experienced
                team.
              </h4>
                ...
                <div class="card">
                  ...
                  >
                    <div class="card-body">
                      ...
                      quis ratione sequi et vesciunt, neque et quis autem velis
                ...
                <div class="card">
                  ...
                  >
                    <div class="card-body">
                      ...
                      netsum loris fugit, sed quia magni dolores eos qui ratione
                      sequi nesciunt, neque et quis autem velis reprehenderit
                      ets quis velit.
                    </div>
                  </div>
                </div>
        ...
        <div class="row">
          ...
          <div class="col-md-12 text-center padding-bottom-10">
            ...
            <p class="section-subtitle white">
              ...
              <a href="#" class="register-link">get in touch here</a> or call us
              <b>+44 987 654 321</b>
            </p>
          </div>
          <!--end col-md-12 -->
            ...
            >
              ...
              <div>
                ...
                <p class="register-form-terms">
                  Free 14-Day Trial • Money Back Guarantee
                </p>
              </div>
              <!--end form-->
            </div>
    ...
    <div class="footer">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-5">
            <p>
              © 2020 <span class="template-name">Control-20</span>.
              <!-- Designed by <a href="https://themeforest.net/user/epic-themes/portfolio?ref=Epic-Themes" target="_blank">Epic-Themes</a> -->
            </p>
          </div>
          <!--end col-md-5 -->
